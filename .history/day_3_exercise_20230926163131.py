...
# ========================
search_string = "I hope this course is not full of jargon"

if 'jargon' in search_string:
    print('Yes')
else:
    print('No')
...
text = 'Python'
text_len = len(text)
convert_num_to_float = float(text_len)
convert_float_to_str = str(convert_num_to_float)
print('convert num to float: ', type(convert_num_to_float))
print('convert float to str: ', type(convert_float_to_str))
