...
print("The area of the circle is: ", circum_of_circle)

user_first_name = input('Enter your firtname: ')
user_last_name = input('Enter your lastname: ')
user_country = input('Enter your country: ')
user_age = input('Enter your age: ')
user_full_name = user_first_name + ' ' + user_last_name
print("Full Name:", user_full_name,"\nCountry:", user_country ,"Age : ", user_age )
